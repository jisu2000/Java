...
public class QueueUse {
    ...
    private static void timesdel(Queue_Arr Q, int times) throws QueueEmptyError {
    ...
    private static void deleteall(Queue_Arr Q) throws QueueEmptyError {
